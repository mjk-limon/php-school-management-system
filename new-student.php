...
<?php
	if(isset($_POST['add_student'])) {
		...
		if($conn->query(InsertInTable("students", $fields))) {
			$stdid = $conn->insert_id;
			header("Location: bill-pay.php?stdid={$stdid}");
		} else header("Location: new-student.php?emsg=".urlencode($conn->error));
	}
?>
<!DOCTYPE html>
<html lang="en">
											...
											<div class="panel-body">
												<form role="form" enctype="multipart/form-data" name="addpatient" method="post" onSubmit="return valid();">
													...
													<div class="form-group">
														...
														<input type="text" name="full_name" class="form-control" placeholder="Enter Student Name" required />
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="text" name="mothers_name" class="form-control" placeholder="Enter Mother's Name" required />
													</div>
													<div class="form-group">
														<label>Gender</label>
